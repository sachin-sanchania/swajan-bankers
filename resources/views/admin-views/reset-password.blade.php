    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="ibox-content">
                <form class="m-t" role="form" action="#" method="post" name="resetform" id="resetform" autocomplete="off">
                    @csrf
                    <div class="form-group">
                        <h1 class="headerLogin">Reset Password</h1>
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Enter Your New Password Here" name="password" id="password">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Re Enter Your New Password Here" name="repassword" id="repassword">
                    </div>
...
<script src="{{url('admin/js/CustomReset.js')}}"></script>
</html>
