                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title ">
                        ...
                        <div class="ibox-tools">
                            <a href="{{url('admin/testimonial/create')}}"><button class="btn btn-success btn-sm"><i class="fa fa-plus"></i> <b>Add</b></button></a>
                        </div>
                    </div>
                    ...
                    },
                    {
                        render: function ( data, type, row ) {
                            if(row.image_path == "null" || row.image_path === null || row.image_path == ""){
                                ...
                                return '<img src="../uploads/testimonial/'+row.image_path+'" height=50 width=50>';
                            }
                        },
